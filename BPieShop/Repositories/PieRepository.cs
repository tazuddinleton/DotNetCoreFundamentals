...
namespace BPieShop.Models
{
    public class PieRepository : IPieRepository
    {
        ...
        {
            _pies.Add(new Pie() {
                PieId = 1, Name = "Strawberry Pie", Price = 15.95M, CategoryId=1, ShortDescription = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!" 
                ,Reviews = new List<PieReview>() { new PieReview() { Rating = 3} }
            });
